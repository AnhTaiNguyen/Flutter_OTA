...
class VehicleInfo {
  ...
  factory VehicleInfo.fromJson(Map<String, dynamic> json) {
    return VehicleInfo(
        description: json['description'], versionName: json['version']);
  }
}
  ...
  void fetchUserData() async {
    ...
    if (user != null) {
      ...
      if (snapshot.docs.isNotEmpty) {
        ...
        fetchData(carId);
        fetchUpdateInfo(carId);
      }
    }
  }

  Future<VehicleInfo> fetchUpdateInfo(String carId) async {
    var response = await networkHandler.getUpdateInfo(
      "https://api.eu1.bosch-iot-rollouts.com/rest/v1/targets/$carId/assignedDS",
    );
    setState(() {
